...
- Optional background fields: `background_color` accepts `#RRGGBB`/`#RRGGBBAA` (alpha optional), and `background_border_width` accepts integers 0–10 to expand the fill equally on all sides. Omit to keep the group transparent.
