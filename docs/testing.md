...
1. **4:3 Fit baseline**  
   ...
   - Replay the LandingPad log: `python3 tests/send_overlay_from_log.py --log payload_store/\1`.  
...
4. **Prefix-based grouping**  
   ...
   - Replay `payload_store/\1` or your plugin’s log via `tests/send_overlay_from_log.py`.  
