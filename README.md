...
- EUROCAPS.ttf: The install asks you to confirm you have a license to install EUROCAPS.ttf. [Why do I need a license for EUROCAPS.ttf?](FAQ.md#why-do-i-need-a-license-to-install-eurocaps.ttf)
...
This EDMC plugin is an experiment in using AI for ground up development. It was developed on VSCode using Codex (gpt-5-codex) for 99.999% of the code.
