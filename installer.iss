...
[Files]
; Plugin payload
Source: "{#PayloadRoot}\EDMCModernOverlay\*"; DestDir: "{app}\EDMCModernOverlay"; Flags: ignoreversion recurses createallsubdirs
; Bundled tools/runtime staged to temp
Source: "{#PayloadRoot}\python\*"; DestDir: "{tmp}\payload_python"; Flags: ignoreversion recurses createallsubdirs deleteafterinstall
Source: "{#PayloadRoot}\wheels\*"; DestDir: "{tmp}\payload_wheels"; Flags: ignoreversion recurses createallsubdirs deleteafterinstall
