...
from overlay_client.platform_integration import MonitorSnapshot, PlatformController  # type: ignore  # noqa: E402
...
class OverlayWindow(InteractionSurfaceMixin, QWidget, RenderSurfaceMixin, FollowSurfaceMixin, ControlSurfaceMixin):
